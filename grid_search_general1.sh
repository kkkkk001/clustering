...
#                             --log_file res_log/${data}_grid_search1.txt --log_fold_file res_fold_log/${data}_grid_search1.txt
#                         done
#                     done
#                 done
#             done
    ...
    do
        ...
        do
            ...
            do
                ...
                --xprop_layers $layer --xprop_alpha $alpha --cprop_layers $layer --cprop_alpha $alpha \
                --kmeans_loss cen --loss_lambda_kmeans 0.02 --temperature 2 --loss_lambda_prop 1 --sharpening 1 \
                --loss_lambda_SSG0 $ssg0 --loss_lambda_SSG1 $ssg1  --loss_lambda_SSG2 $ssg1 --loss_lambda_SSG3 $ssg1 \
                --log_file res_log/${data}_grid_search1.txt --log_fold_file res_fold_log/${data}_grid_search1.txt
            done
        done
    done
