...
if __name__ == '__main__':
    ...
    print_eval(clusters, data.y.cpu().numpy(), adjacency)
    
    print('kmeans: ', end='')
    cluster_ids,_ = k_means(x.detach(), len(np.unique(data.y.cpu().numpy())), device='gpu', distance='cosine')
    print_eval(cluster_ids, data.y.cpu().numpy(), adjacency)
